...
#we are using HTML to access Chrome's Speech recognition but we have kept its language selection emty and we give it its language through .env variable where we can keep which ever language we wish to talk into
    ...
    while True:
        try:
            ...
            if text:
                ...
                if InputLanguage.lower() == "en" or InputLanguage.lower() == "en-us":
...
if __name__ == '__main__':
    while True:
        ...
        print(text)
#remember to use updated version of Tensorflow
