...
AssistantVoice = env_vars.get('Voice') # Get the AssistantVoice from the environment variables

# Asynchronous function to convert text to an audio file 
#Asyn makes it super fast
async def TextToAudioFile(text) -> None:
    ...
    # Create the communicate object to generat e speech from text  using edge_tts
...
if __name__ == "__main__":
    while True:
        ...
        #if we want our assistant to speak whole text then directly call TTS function no need to call TextToSpeech function